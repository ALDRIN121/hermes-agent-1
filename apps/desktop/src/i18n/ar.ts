...
export const ar = defineLocale({
  ...
  settings: {
    ...
    vault: {
      ...
      blurb:
        'بيانات اعتماد محلية مشفّرة يمكن للوكيل استخدامها لتسجيل الدخول إلى المواقع دون أن يرى القيم أبداً. لا يظهر للنموذج سوى التسميات والأصول.',
      count: n => `${n} محفوظة`,
      loadFailed: 'تعذّر تحميل عناصر الخزنة',
      empty: 'لا توجد بيانات اعتماد محفوظة بعد',
      emptyDesc:
        'أضف تسجيل دخول ليتمكن الوكيل من الدخول إلى ذلك الموقع نيابةً عنك — لا يتلقى سوى مقبض مبهم، وليس كلمة المرور أبداً.',
      add: 'إضافة بيانات اعتماد',
      addTitle: 'إضافة بيانات اعتماد',
      addDescription: 'تُخزَّن مشفّرة على هذا الجهاز. لا يرى الوكيل القيم السرية أبداً.',
